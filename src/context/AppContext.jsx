...
const SEED_JOBS = [
  ...
  { id:'j9',  title:'MTH 101 and STA 101 tutor needed — 100-level Engineering student, UNI',         category:'Academic Support',     budget:2000,   type:'Hourly', posted:'2 days ago',   proposals:5,  description:'I am a 100-level Engineering student at UNI struggling with MTH 101 (Calculus I) and STA 101 (Probability and Statistics). I need an experienced tutor who can explain concepts clearly, work through past exam questions with me, and help me prepare for my semester tests. I prefer Zoom or in-library sessions, twice per week.', skills:['Calculus','Statistics','Mathematics','Teaching'], status:'open', duration:'4 weeks' },
  { id:'j10', title:'Photographer for Chemical Engineering convocation dinner — UNI Campus', category:'Photography',           budget:50000,  type:'Fixed',  posted:'10 hours ago', proposals:4,  description:'The Department of Chemical Engineering, UNI is hosting its convocation dinner for the graduating class of 2026. We need a professional photographer for the full 4-hour event: arrival shots, award ceremony, dinner service, group photographs, and candid moments. Venue is the UNI Staff Club. Edited and colour-graded photos to be delivered within 72 hours.', skills:['Event Photography','Lightroom','Portrait','Photo Editing'], status:'open', duration:'1 evening' },
  { id:'j11', title:'Social media manager for UNI Student Union Government — 2-month contract',       category:'Sales & Marketing',    budget:80000,  type:'Fixed',  posted:'1 day ago',    proposals:7,  description:'The Student Union Government, UNI needs a social media manager for our official Instagram and X (Twitter) accounts over 2 months. Responsibilities include: 5 posts per week, managing DMs and comments, live coverage of SUG events, and bi-weekly analytics reports presented to the PRO. Content ideas will be provided. Candidate must understand Nigerian campus culture.', skills:['Instagram','Twitter/X','Content Creation','Canva'], status:'open', duration:'2 months' },
]
