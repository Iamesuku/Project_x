...
const SEED_FREELANCERS = [
  ...
  { id:'f2',  name:'Emeka Nwosu',       avatar:'EN', title:'Full-Stack Developer',    role:'freelancer', rate:6500, rating:4.8, reviews:189, skills:['React','Node.js','PostgreSQL','Firebase'],                        bio:'Final-year Computer Science student at University of Ibadan. I build production-ready web apps. Delivered 8+ campus projects including the engineering faculty alumni platform.',         location:'Lagos (UNILAG)',       completedJobs:134, category:'Development & IT',  emailVerified:true, memberSince:'2025-08-15' },
  { id:'f3',  name:'Fatimah Bello',     avatar:'FB', title:'Brand Strategist',        role:'freelancer', rate:3500, rating:5.0, reviews:58,  skills:['Brand Identity','Copywriting','Strategy','Positioning'],          bio:'Business Administration student, ABU Zaria. Former brand lead for StartUp ABU innovation hub. I help student entrepreneurs build brands that stand out in the marketplace.',           location:'Lagos (UNILAG)',       completedJobs:47,  category:'Sales & Marketing', emailVerified:true, memberSince:'2025-10-01' },
  { id:'f4',  name:'Olumide Adeyemi',   avatar:'OA', title:'Motion Designer',         role:'freelancer', rate:3000, rating:4.7, reviews:84,  skills:['After Effects','Premiere Pro','Lottie','Cinema 4D'],              bio:'Creative Arts final year at OAU Ile-Ife. I create motion graphics for campus events and student brands. Worked on the OAU 50th anniversary visual campaign.',                         location:'Lagos (UNILAG)',     completedJobs:63,  category:'Design & Creative',    emailVerified:true, memberSince:'2025-07-10' },
  { id:'f5',  name:'Amina Garba',       avatar:'AG', title:'Data Analyst',            role:'freelancer', rate:4000, rating:4.9, reviews:49,  skills:['Python','R','Tableau','SQL'],                                     bio:'Statistics student at Bayero University Kano. I help research teams clean and visualize their data. Proficient in SPSS, R, and Tableau for academic and commercial projects.',          location:'Lagos (UNILAG)',        completedJobs:35,  category:'Development & IT',  emailVerified:true, memberSince:'2025-09-10' },
  ...
  { id:'f7',  name:'Ngozi Okafor',      avatar:'NO', title:'Mobile Developer',        role:'freelancer', rate:7000, rating:4.8, reviews:72,  skills:['Flutter','React Native','Kotlin','Firebase'],                     bio:'CS student at University of Nigeria, Nsukka. Creator of CampusRide, a student ride-sharing app with 800+ downloads. I build iOS and Android apps from scratch to production launch.',  location:'Lagos (UNILAG)',      completedJobs:58,  category:'Development & IT',  emailVerified:true, memberSince:'2025-08-01' },
  { id:'f8',  name:'Ibrahim Danjuma',   avatar:'ID', title:'Financial Analyst',       role:'freelancer', rate:5000, rating:5.0, reviews:37,  skills:['Financial Modeling','Excel','FP&A','PowerPoint'],                 bio:'ACA student finalist at ABU Zaria. I build financial models and pitch decks for student entrepreneurs. Helped 6 campus startups secure grant and investor funding.',                    location:'Lagos (UNILAG)',       completedJobs:28,  category:'Finance & Accounting', emailVerified:true, memberSince:'2025-10-05' },
  { id:'f9',  name:'Segun Afolabi',     avatar:'SA', title:'DevOps Engineer',         role:'freelancer', rate:5500, rating:4.8, reviews:56,  skills:['AWS','Docker','Terraform','Linux'],                               bio:'Computer Engineering student at FUOYE. AWS certified. I set up cloud infrastructure and CI/CD pipelines for campus startups so your applications stay up and scale reliably.',          location:'Lagos (UNILAG)', completedJobs:44,  category:'Development & IT',  emailVerified:true, memberSince:'2025-07-25' },
  ...
  { id:'f11', name:'Taiwo Adeleke',     avatar:'TA', title:'Academic Tutor',          role:'freelancer', rate:2000, rating:4.8, reviews:31,  skills:['Mathematics','Statistics','Physics','Further Maths'],             bio:'400-level Mathematics student at OAU. I tutor 100-300 level students in MTH, STA, and PHY courses. Patient teaching style — students consistently improve after our sessions.',        location:'Lagos (UNILAG)',     completedJobs:25,  category:'Academic Support',  emailVerified:true, memberSince:'2025-09-15' },
  ...
  { id:'f13', name:'Kelechi Eze',       avatar:'KE', title:'Social Media Manager',    role:'freelancer', rate:3000, rating:4.7, reviews:11,  skills:['Instagram','TikTok','Canva','Content Calendar'],                  bio:'Marketing student at LASU. I manage Instagram and TikTok for 5 student associations and 2 campus brands. Average 40% engagement growth within the first month of working together.',   location:'Lagos (UNILAG)',      completedJobs:9,   category:'Sales & Marketing', emailVerified:true, memberSince:'2025-11-05' },
  { id:'f14', name:'Tunde Fashola',     avatar:'TF', title:'Video Editor',            role:'freelancer', rate:2000, rating:4.6, reviews:20,  skills:['Premiere Pro','DaVinci Resolve','After Effects','CapCut'],        bio:'Theatre Arts student at UI. I edit event recap videos, vlogs, and social content for campus brands. Experienced in live event coverage at UI drama festivals and departmental events.',  location:'Lagos (UNILAG)',       completedJobs:16,  category:'Design & Creative',    emailVerified:true, memberSince:'2025-09-20' },
]
...
const SEED_JOBS = [
  ...
  { id:'j9',  title:'MTH 101 and STA 101 tutor needed — 100-level Engineering student, FUTA',         category:'Academic Support',     budget:2000,   type:'Hourly', posted:'2 days ago',   proposals:5,  description:'I am a 100-level Engineering student at FUTA struggling with MTH 101 (Calculus I) and STA 101 (Probability and Statistics). I need an experienced tutor who can explain concepts clearly, work through past exam questions with me, and help me prepare for my semester tests. I prefer Zoom or in-library sessions, twice per week.', skills:['Calculus','Statistics','Mathematics','Teaching'], status:'open', duration:'4 weeks' },
  { id:'j10', title:'Photographer for Chemical Engineering convocation dinner — University of Ibadan', category:'Photography',           budget:50000,  type:'Fixed',  posted:'10 hours ago', proposals:4,  description:'The Department of Chemical Engineering, University of Ibadan is hosting its convocation dinner for the graduating class of 2026. We need a professional photographer for the full 4-hour event: arrival shots, award ceremony, dinner service, group photographs, and candid moments. Venue is the UI Senior Staff Club. Edited and colour-graded photos to be delivered within 72 hours.', skills:['Event Photography','Lightroom','Portrait','Photo Editing'], status:'open', duration:'1 evening' },
  { id:'j11', title:'Social media manager for OAU Student Union Government — 2-month contract',       category:'Sales & Marketing',    budget:80000,  type:'Fixed',  posted:'1 day ago',    proposals:7,  description:'The Student Union Government, OAU Ile-Ife needs a social media manager for our official Instagram and X (Twitter) accounts over 2 months. Responsibilities include: 5 posts per week, managing DMs and comments, live coverage of SUG events, and bi-weekly analytics reports presented to the PRO. Content ideas will be provided. Candidate must understand Nigerian campus culture.', skills:['Instagram','Twitter/X','Content Creation','Canva'], status:'open', duration:'2 months' },
]
